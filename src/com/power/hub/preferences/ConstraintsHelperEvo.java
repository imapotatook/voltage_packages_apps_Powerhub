 ...
 * @hide
 */
public class ConstraintsHelperEvo {

    private static final String TAG = "ConstraintsHelperEvo";
    ...
    public ConstraintsHelperEvo(Context context, AttributeSet attrs, Preference pref) {
        mContext = context;
        mAttrs = attrs;
        mPref = pref;
