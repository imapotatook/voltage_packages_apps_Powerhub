 ...
 */
public abstract class SelfRemovingSwitchPreferenceEvo extends SwitchPreference {

    private final ConstraintsHelperEvo mConstraints;

    public SelfRemovingSwitchPreferenceEvo(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mConstraints = new ConstraintsHelperEvo(context, attrs, this);
        setPreferenceDataStore(new DataStore());
    }

    public SelfRemovingSwitchPreferenceEvo(Context context, AttributeSet attrs) {
        super(context, attrs);
        mConstraints = new ConstraintsHelperEvo(context, attrs, this);
        setPreferenceDataStore(new DataStore());
    }

    public SelfRemovingSwitchPreferenceEvo(Context context) {
        super(context);
        mConstraints = new ConstraintsHelperEvo(context, null, this);
        setPreferenceDataStore(new DataStore());
    }
    ...
    private class DataStore extends PreferenceDataStore {
        ...
        public void putBoolean(String key, boolean value) {
            SelfRemovingSwitchPreferenceEvo.this.putBoolean(key, value);
        }

        @Override
        public boolean getBoolean(String key, boolean defaultValue) {
            return SelfRemovingSwitchPreferenceEvo.this.getBoolean(key, defaultValue);
        }
    }
}
